  ...
  <tr>
  	<th class="">น้อย/ทุก 2-5 ปี</th>
        <td class="custom_class" style="background-color:#cccccc">
            <center><?= Html::a($r1c1, ['/report/matrixlink','born' =>1,'score'=>0]) ?></center>

          <td class="custom_class" style="background-color:#9fda58">
          <center><?= Html::a($r1c2, ['/report/matrixlink','born' =>1,'score'=>1]) ?></center>
          </td>
          <td class="custom_class" style="background-color:#9fda58">
         <center><?= Html::a($r1c3, ['/report/matrixlink','born' =>1,'score'=>2]) ?></center>
          </td>
          <td class="custom_class" style="background-color:yellow">
          <center><?= Html::a($r1c4, ['/report/matrixlink','born' =>1,'score'=>3]) ?></center>
          </td>
          <td class="custom_class" style="background-color:yellow">
         <center><?= Html::a($r1c5, ['/report/matrixlink','born' =>1,'score'=>4]) ?></center>
          </td>
  </tr>
  <tr>
  	<th class="">ปานกลาง/ทุกปี</th>
        <td class="custom_class" style="background-color:#cccccc">
  <center><?= Html::a($r2c1, ['/report/matrixlink','born' =>2,'score'=>0]) ?></center>
          </td>
          <td class="custom_class" style="background-color:#9fda58">
        <center><?= Html::a($r2c2, ['/report/matrixlink','born' =>2,'score'=>1]) ?></center>
          </td>
  	<td class="custom_class" style="background-color:yellow">
       <center><?= Html::a($r2c3, ['/report/matrixlink','born' =>2,'score'=>2]) ?></center>
          </td>
  	<td class="custom_class" style="background-color:orange">
        <center><?= Html::a($r2c4, ['/report/matrixlink','born' =>2,'score'=>3]) ?></center>
          </td>
  	<td class="custom_class" style="background-color:orange">
        <center><?= Html::a($r2c5, ['/report/matrixlink','born' =>2,'score'=>4]) ?></center>
          </td>
  </tr>
  <tr>
  	<th class="">สูง/ทุกเดือน</th>
        <td class="custom_class" style="background-color:#cccccc">
  <center><?= Html::a($r3c1, ['/report/matrixlink','born' =>3,'score'=>0]) ?></center>
          </td>
  	<td class="custom_class" style="background-color:yellow">
        <center><?= Html::a($r3c2, ['/report/matrixlink','born' =>3,'score'=>1]) ?></center>
          </td>
  	<td class="custom_class" style="background-color:orange">
        <center><?= Html::a($r3c3, ['/report/matrixlink','born' =>3,'score'=>2]) ?></center>
          </td>
  	<td class="custom_class" style="background-color:red">
        <center><?= Html::a($r3c4, ['/report/matrixlink','born' =>3,'score'=>3]) ?></center>
          </td>
  	<td class="custom_class" style="background-color:red">
        <center><?= Html::a($r3c5, ['/report/matrixlink','born' =>3,'score'=>4]) ?></center>
          </td>
  </tr>
  <tr>
  	<th class="">สูงมาก/ทุกวัน</th>
       <td class="custom_class" style="background-color:#cccccc">
  <center><?= Html::a($r4c1, ['/report/matrixlink','born' =>4,'score'=>0]) ?></center>
          </td>
    <td class="custom_class" style="background-color:yellow">
<center><?= Html::a($r4c2, ['/report/matrixlink','born' =>4,'score'=>1]) ?></center>
    </td>
    <td class="custom_class" style="background-color:orange">
    <center><?= Html::a($r4c3, ['/report/matrixlink','born' =>4,'score'=>2]) ?></center>
          </td>
    <td class="custom_class" style="background-color:red">
    <center><?= Html::a($r4c4, ['/report/matrixlink','born' =>4,'score'=>3]) ?></center>
          </td>
    <td class="custom_class" style="background-color:red">
    <center><?= Html::a($r4c5, ['/report/matrixlink','born' =>4,'score'=>4]) ?></center>
          </td>
  </tr>
  </table>
       </div>
